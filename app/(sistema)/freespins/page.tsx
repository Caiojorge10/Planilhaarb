...
export default function FreeSpinsPage() {
  ...
  const [form, setForm] = useState<{ casaId?: number; valorGanho?: number }>({});
    ...
    <div className="max-w-2xl mx-auto p-4">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded shadow p-4 mb-6 flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <select name="casaId" value={form.casaId || ""} onChange={handleChange} required className="border p-2 rounded">
